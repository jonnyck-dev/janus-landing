...
window.JANUS_I18N = {
  es: {
    ...
    'nav.nuevo_proyecto': 'Nuevo proyecto',
    ...
    'meta.studio.title': 'JANUS Studio — Doblaje y traducción con IA',
    'meta.studio.desc': 'Tu centro de operaciones de doblaje: pega la URL de tu video, sigue tu cola de renderizado y consulta tu historial.',

    // ---------- JANUS Studio ----------
    'studio.login_title': 'JANUS Studio',
    'studio.login_required': 'Inicia sesión para usar JANUS Studio.',
    'studio.title': 'JANUS Studio',
    'studio.subtitle': 'Tu centro de operaciones de doblaje.',
    'studio.credits_title': 'Mis créditos',
    'studio.credits_empty': 'No tienes créditos activos.',
    'studio.credits_login': 'Iniciar sesión para ver créditos',
    'studio.buy': 'Comprar créditos',
    'studio.delivery_note': 'El renderizado tiene un plazo de entrega máximo de 1 día.',
    'studio.queue_title': 'Videos en cola',
    'studio.queue_empty': 'No tienes videos en cola.',
    'studio.form_title': 'Traducir y Doblar Video',
    'studio.form_sub': 'Pega la URL de un video de YouTube. JANUS detectará el idioma original y lo traducirá al idioma que elijas.',
    'studio.url_placeholder': 'https://www.youtube.com/watch?v=...',
    'studio.start': 'Comenzar',
    'studio.lang_label': 'Idioma de destino',
    'studio.lang_es': 'Español',
    'studio.lang_en': 'Inglés',
    'studio.job_submitted': 'Video agregado a la cola. Entrega estimada: máx. 1 día.',
    'studio.adding': 'Agregando a la cola...',
    'studio.err_nocredit': 'Necesitas un crédito para continuar. Compra uno para doblar tu video.',
    'studio.err_submit': 'No se pudo agregar el video. Inténtalo de nuevo.',
    'studio.err_duplicate': 'Ese video ya está en cola. Espera a que se procese.',
    'studio.err_url': 'Pega una URL válida de YouTube.',
    'studio.history_title': 'Historial',
    'studio.history_empty': 'Aún no hay videos procesados.',
    'studio.loading': 'Cargando...',
    'studio.status.pending': 'En cola',
    'studio.status.pending_payment': 'Esperando pago',
    'studio.status.processing': 'Procesando',
    'studio.status.done': 'Procesado',
    'studio.status.failed': 'Fallido',
    'studio.status.cancelled': 'Cancelado',
    'nav.admin': 'Panel Admin',
    'admin.title': 'Panel de Administración',
    'admin.subtitle': 'Doblajes solicitados por los clientes.',
    'admin.no_access_title': 'Acceso restringido',
    'admin.no_access': 'No tienes acceso a esta página.',
    'admin.all': 'Todos los trabajos',
    'admin.loading': 'Cargando...',
    'admin.empty': 'No hay trabajos en esta categoría.',
    'admin.filter_pending': 'En cola',
    'admin.filter_processing': 'Procesando',
    'admin.filter_done': 'Procesados',
    'admin.filter_all': 'Todos',
    'admin.delivered': 'Entregado',
    'admin.note_ph': 'Nota interna (para tu referencia)...',
    'admin.btn_processing': 'Procesando',
    'admin.btn_done': 'Marcar Procesado',
    'admin.btn_failed': 'Fallido',
    'admin.btn_reopen': 'Reabrir',
    'admin.btn_save': 'Guardar nota',
    ...
    'auth.profile.credits_count_one': '1 crédito activo',
    ...
    'auth.profile.email_verified': 'Correo verificado',
    'auth.profile.email_unverified': 'Correo no verificado',
    'auth.profile.verify_email': 'Verificar email',
    'auth.profile.verify_sent': 'Te enviamos el enlace de verificación. Revisa tu bandeja.',
    ...
    'legal.terminos.entrega.p': 'Tras solicitar el renderizado de un video en JANUS Studio, la entrega del resultado se realiza en un plazo máximo de 1 día desde la recepción de la solicitud.',
  ...
  en: {
    ...
    'nav.agencia': 'Agency',
    'nav.probar': 'Try now',
    'nav.nuevo_proyecto': 'New project',
    ...
    'meta.studio.title': 'JANUS Studio — AI dubbing and translation',
    'meta.studio.desc': 'Your dubbing operations hub: paste your video URL, track your rendering queue, and view your history.',

    // ---------- JANUS Studio ----------
    'studio.login_title': 'JANUS Studio',
    'studio.login_required': 'Sign in to use JANUS Studio.',
    'studio.title': 'JANUS Studio',
    'studio.subtitle': 'Your dubbing operations hub.',
    'studio.credits_title': 'My credits',
    'studio.credits_empty': 'You have no active credits.',
    'studio.credits_login': 'Sign in to see credits',
    'studio.buy': 'Buy credits',
    'studio.delivery_note': 'Rendering has a maximum delivery period of 1 day.',
    'studio.queue_title': 'Videos in queue',
    'studio.queue_empty': 'You have no videos in queue.',
    'studio.form_title': 'Translate and Dub Video',
    'studio.form_sub': 'Paste a YouTube video URL. JANUS will detect the original language and translate it to the language you choose.',
    'studio.url_placeholder': 'https://www.youtube.com/watch?v=...',
    'studio.start': 'Start',
    'studio.lang_label': 'Target language',
    'studio.lang_es': 'Spanish',
    'studio.lang_en': 'English',
    'studio.job_submitted': 'Video added to the queue. Estimated delivery: max. 1 day.',
    'studio.adding': 'Adding to queue...',
    'studio.err_nocredit': 'You need a credit to continue. Buy one to dub your video.',
    'studio.err_submit': 'Could not add the video. Please try again.',
    'studio.err_duplicate': 'That video is already in the queue. Please wait for it to be processed.',
    'studio.err_url': 'Paste a valid YouTube URL.',
    'studio.history_title': 'History',
    'studio.history_empty': 'No processed videos yet.',
    'studio.loading': 'Loading...',
    'studio.status.pending': 'Queued',
    'studio.status.pending_payment': 'Awaiting payment',
    'studio.status.processing': 'Processing',
    'studio.status.done': 'Processed',
    'studio.status.failed': 'Failed',
    'studio.status.cancelled': 'Cancelled',
    'nav.admin': 'Admin Panel',
    'admin.title': 'Admin Panel',
    'admin.subtitle': 'Dubbing jobs requested by clients.',
    'admin.no_access_title': 'Restricted access',
    'admin.no_access': 'You don\'t have access to this page.',
    'admin.all': 'All jobs',
    'admin.loading': 'Loading...',
    'admin.empty': 'No jobs in this category.',
    'admin.filter_pending': 'Queued',
    'admin.filter_processing': 'Processing',
    'admin.filter_done': 'Processed',
    'admin.filter_all': 'All',
    'admin.delivered': 'Delivered',
    'admin.note_ph': 'Internal note (for your reference)...',
    'admin.btn_processing': 'Processing',
    'admin.btn_done': 'Mark Processed',
    'admin.btn_failed': 'Failed',
    'admin.btn_reopen': 'Reopen',
    'admin.btn_save': 'Save note',
    ...
    'auth.profile.credits_count_one': '1 active credit',
    ...
    'auth.profile.email_verified': 'Email verified',
    'auth.profile.email_unverified': 'Email not verified',
    'auth.profile.verify_email': 'Verify email',
    'auth.profile.verify_sent': 'We sent you the verification link. Check your inbox.',
    ...
    'legal.terminos.entrega.p': 'After requesting the rendering of a video in JANUS Studio, the result is delivered within a maximum period of 1 day from receipt of the request.',
