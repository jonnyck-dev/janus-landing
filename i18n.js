...
window.JANUS_I18N = {
  es: {
    ...
    // ---------- Pricing ----------
    'pr.eyebrow': 'Precios',
    'pr.title': 'Un video. Un precio. Sin sorpresas.',
    'pr.subtitle': 'Traducción profesional y clonación de voz por video, hasta 40 minutos de duración.',
    'pr.unit': '/ video',
    'pr.cta': 'Comenzar',
    'pr.badge': 'Más elegido',
    'pr.essential.name': 'Esencial',
    'pr.essential.tagline': 'Para un solo hablante',
    ...
    'pr.essential.delivery': 'Entrega en 2 días',
    'pr.essential.revision': '1 revisión',
    'pr.multivoice.name': 'Multi-Voz',
    'pr.multivoice.tagline': 'Podcasts, entrevistas y diálogos',
    ...
    'pr.multivoice.delivery': 'Entrega en 2 días',
    'pr.multivoice.revision': '2 revisiones',
    'pr.global.name': 'Global',
    'pr.global.tagline': 'Más allá del inglés y español',
    ...
    'pr.global.delivery': 'Entrega en 3 días',
    'pr.global.revision': '3 revisiones',
    'pr.note.html': 'Todos los planes cubren videos de hasta 40 minutos. Al continuar aceptas nuestros <a href="legal.html#terminos">Términos de Servicio</a> y <a href="legal.html#reembolsos">Política de Reembolsos</a>.',
    ...
    'legal.terminos.s3': 'Cada plan incluye las revisiones indicadas en su descripción. Una revisión cubre ajustes razonables sobre el trabajo entregado; no incluye cambios de alcance (por ejemplo, reemplazar el video de origen).',
    'legal.terminos.s4': 'El resultado se entrega como archivo digital listo para publicar.',
    ...
    'legal.reembolsos.p1.html': 'JANUS vende <strong>servicios digitales</strong>; no comercializamos productos físicos, por lo que no aplican devoluciones de mercancía.',
    'legal.reembolsos.cuando': 'Cuándo procede un reembolso',
    'legal.reembolsos.c1.html': '<strong>Antes de iniciar el trabajo:</strong> reembolso completo si cancelas antes de que comencemos a procesar tu video.',
    'legal.reembolsos.c2.html': '<strong>Trabajo no entregado:</strong> reembolso completo si no entregamos tu video dentro del plazo comprometido sin causa justificada ni acuerdo contigo.',
    'legal.reembolsos.c3.html': '<strong>Defecto técnico no resoluble:</strong> si el resultado presenta un defecto técnico imputable a nosotros (por ejemplo, audio corrupto o desincronización grave) y no logramos corregirlo mediante las revisiones incluidas, ofreceremos un reembolso total o parcial proporcional.',
    'legal.reembolsos.no': 'Cuándo no procede',
    'legal.reembolsos.n1': 'Trabajo ya entregado y aceptado, o conforme a lo descrito en el plan contratado.',
    'legal.reembolsos.n2': 'Insatisfacción subjetiva una vez agotadas las revisiones incluidas en el plan.',
    ...
    'legal.reembolsos.como.p.html': 'Antes de abrir una disputa con tu banco o con Stripe, contáctanos en <a href="mailto:support@janusdubber.website">support@janusdubber.website</a>. Respondemos en un plazo de 24–48 horas laborables y resolvemos la mayoría de los casos directamente. Las solicitudes de reembolso se evalúan y, si proceden, se procesan al mismo medio de pago en un plazo de 5 a 10 días hábiles.',
    'legal.cancelacion.title': 'Política de Cancelación',
    'legal.cancelacion.p1': 'JANUS trabaja por pedido (no hay suscripciones recurrentes que cancelar).',
    'legal.cancelacion.l1.html': '<strong>Cancelación gratuita</strong> en cualquier momento antes de que iniciemos el procesamiento de tu video, con reembolso completo.',
    'legal.cancelacion.l2.html': '<strong>Una vez iniciado el procesamiento</strong>, el pedido no puede cancelarse: el trabajo de traducción, clonación y sincronización ya está en marcha y consume recursos. En casos excepcionales podemos evaluar un reembolso parcial según el avance del trabajo.',
    'legal.cancelacion.p2.html': 'Para cancelar un pedido, escribe a <a href="mailto:support@janusdubber.website">support@janusdubber.website</a> indicando tu email de compra y los detalles del pedido.',
  ...
  en: {
    ...
    // ---------- Pricing ----------
    'pr.eyebrow': 'Pricing',
    'pr.title': 'One video. One price. No surprises.',
    'pr.subtitle': 'Professional translation and voice cloning per video, up to 40 minutes long.',
    'pr.unit': '/ video',
    'pr.cta': 'Start',
    'pr.badge': 'Most popular',
    'pr.essential.name': 'Essential',
    'pr.essential.tagline': 'For a single speaker',
    ...
    'pr.essential.delivery': 'Delivery in 2 days',
    'pr.essential.revision': '1 revision',
    'pr.multivoice.name': 'Multi-Voice',
    'pr.multivoice.tagline': 'Podcasts, interviews and dialogue',
    ...
    'pr.multivoice.delivery': 'Delivery in 2 days',
    'pr.multivoice.revision': '2 revisions',
    'pr.global.name': 'Global',
    'pr.global.tagline': 'Beyond English and Spanish',
    ...
    'pr.global.delivery': 'Delivery in 3 days',
    'pr.global.revision': '3 revisions',
    'pr.note.html': 'All plans cover videos up to 40 minutes. By continuing you accept our <a href="legal.html#terminos">Terms of Service</a> and <a href="legal.html#reembolsos">Refund Policy</a>.',
    ...
    'legal.terminos.s3': 'Each plan includes the revisions listed in its description. A revision covers reasonable adjustments to the delivered work; it does not include scope changes (for example, replacing the source video).',
    'legal.terminos.s4': 'The result is delivered as a digital file ready to publish.',
    ...
    'legal.reembolsos.p1.html': 'JANUS sells <strong>digital services</strong>; we do not sell physical products, so merchandise returns do not apply.',
    'legal.reembolsos.cuando': 'When a refund applies',
    'legal.reembolsos.c1.html': '<strong>Before work begins:</strong> full refund if you cancel before we start processing your video.',
    'legal.reembolsos.c2.html': '<strong>Undelivered work:</strong> full refund if we fail to deliver your video within the committed timeframe without justified cause or agreement with you.',
    'legal.reembolsos.c3.html': '<strong>Unresolvable technical defect:</strong> if the result has a technical defect attributable to us (for example, corrupted audio or severe desynchronization) and we cannot fix it through the included revisions, we will offer a proportional total or partial refund.',
    'legal.reembolsos.no': 'When it does not apply',
    'legal.reembolsos.n1': 'Work already delivered and accepted, or conforming to the description of the purchased plan.',
    'legal.reembolsos.n2': 'Subjective dissatisfaction after exhausting the revisions included in the plan.',
    ...
    'legal.reembolsos.como.p.html': 'Before opening a dispute with your bank or with Stripe, contact us at <a href="mailto:support@janusdubber.website">support@janusdubber.website</a>. We respond within 24–48 business hours and resolve most cases directly. Refund requests are evaluated and, if approved, processed to the same payment method within 5 to 10 business days.',
    'legal.cancelacion.title': 'Cancellation Policy',
    'legal.cancelacion.p1': 'JANUS works per order (there are no recurring subscriptions to cancel).',
    'legal.cancelacion.l1.html': '<strong>Free cancellation</strong> at any time before we start processing your video, with a full refund.',
    'legal.cancelacion.l2.html': '<strong>Once processing has started</strong>, the order cannot be cancelled: the translation, cloning, and synchronization work is already underway and consumes resources. In exceptional cases we may evaluate a partial refund based on the work progress.',
    'legal.cancelacion.p2.html': 'To cancel an order, write to <a href="mailto:support@janusdubber.website">support@janusdubber.website</a> indicating your purchase email and the order details.',
